...
<template>
  ...
  <bc-file-list :open-in-scratch="props.openInScratch" :delete-file="props.deleteFile" :get-file-list="getFileList" :file-list="props.fileList" :show-scratch-button="props.showScratchButton" :show-delete-button="props.showDeleteButton" />
</template>
