<script setup>
  ...
  import BcCreateFile from '@/components/BcFile/BcCreateFile.vue'
...
<template>
  ...
  <bc-create-file :create-new-file="props.createNewFile" :upload-file="props.uploadFile" />
  <bc-file-list  :delete-file="props.deleteFile" :get-file-list="getFileList" :file-list="props.fileList" :show-scratch-button="props.showScratchButton" :show-delete-button="props.showDeleteButton" :show-refresh-button="props.showRefreshButton" />
</template>
